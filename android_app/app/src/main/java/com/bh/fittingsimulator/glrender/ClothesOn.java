...
public class ClothesOn {
    ...
    float c_arm_len =(upper_c[3]-fv[4])/2.0f+upper_c[1];
    private float RATIO=  LIMIT/ fv[0];
    private float leg_len= fv[0]- fv[1]- fv[2]- fv[3]- fv[10];
...
*/
        ...
        System.out.println("clotheson's coords update': "+triangleCoords[180]);
